...
class CustomGstInvoice(models.TransientModel):
    ...
    def action_print(self):
        report = self.env.ref('zb_gst_einvoice_irn.gst_invoice_report_qweb_template')
        doc_ids = self.env[self._context['active_model']].browse(self._context['active_id']).ids
        doc_types = []
