...
class PartnerSummaryXlsx(models.AbstractModel):
    _name = 'report.zb_financial_reports.partner_summary_xlsx'
    _inherit = 'report.report_xlsx.abstract'
    _description="Ins Partner Summary Report"
    ...
    #     worksheet.write(9, 5, 'Balance Currency', design_formats['heading_format_3'])
    #     row = 9
    #     col = 0
    ...
    #         worksheet.write(row, col + 5,line.balance_currency,design_formats['normal_format_right'])
