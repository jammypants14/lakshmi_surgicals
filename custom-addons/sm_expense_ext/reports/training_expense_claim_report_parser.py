...
class TrainingExpenseClaimReport(models.AbstractModel):
    _name = 'report.sm_expense_ext.training_expense_claim_template'
    _description = "Training Expense Claim Report"
