...
class PdfPreviewDialog extends Component {
    static template = xml`
        <Dialog title="'PDF Preview'">
            <div class="pdf-preview-dialog" style="height: 80vh; width: 100%;">
                <iframe t-att-src="props.pdfUrl" width="100%" height="100%" style="border: none;"></iframe>
            </div>
            <t t-set-slot="footer">
                <button class="btn btn-primary" t-on-click="() => props.close()">Close</button>
            </t>
